...
public:
    ...
    int handleFrameNetworking(unsigned char playerTag, const unsigned short & turnNumber, const hlt::Map & m, bool ignoreTimeout, hlt::PlayerMoveQueue& moves);
...
private:
    ...
    void deserializeMoveSet(std::string & inputString, const hlt::Map & m, hlt::PlayerMoveQueue& moves);
