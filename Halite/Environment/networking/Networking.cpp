...
void Networking::createAndConnectSocket(int port)
{
#ifdef _WIN32
...
bool Networking::handleInitNetworking(unsigned int timeoutMillis, unsigned char playerTag, std::string name, hlt::Map & m)
{
	try {
