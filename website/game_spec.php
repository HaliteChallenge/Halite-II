	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<p>Once a game ends, the environment will output it as a file for replaying at high speed later. See here for more information regarding the file format.</p>
