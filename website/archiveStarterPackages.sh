...
mkdir Halite-Python-Starter-Package Halite-Java-Starter-Package Halite-C++-Starter-Package Halite-Rust-Starter-Package Halite-CSharp-Starter-Package Halite-Scala-Starter-Package
...
zip -r Halite-CSharp-Starter-Package.zip Halite-CSharp-Starter-Package/ 
