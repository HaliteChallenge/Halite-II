...
Additionally, any player who submits bots that score higher than Two Sigma’s ["Commander Bot"](https://halite.io/user/?user_id=1156){:target="_blank"} may be eligible to interview with Two Sigma for college level roles (full time and internships), and scoring higher than the Commander may also allow bot code to serve in place of a coding test.
