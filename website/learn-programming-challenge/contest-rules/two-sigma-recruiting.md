...
Additionally, any player who submits bots that score higher than Two Sigma’s ["Commander Bot"](http://35.185.45.87/user/?user_id=1156){:target="_blank"} will be eligible to interview with Two Sigma for college level roles (full time and internships), and scoring higher than the Commander also allows bot code to serve in place of a coding test.
