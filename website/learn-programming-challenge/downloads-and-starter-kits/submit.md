...
To play Halite II, you submit a zip file containing your MyBot file and any other files needed to compile and run your MyBot file. Make sure that your MyBot file is in the root directory of your zip - if you zip a folder it won't compile.

Here are some other more advanced instructions for submitting a bot. If you have any questions about these instructions, you should check out the <a href=“https://forums.halite.io” target=“_blank”>Halite forum</a> and get in touch with the Halite community of experts.

For even more advanced players, check out our [tool for uploading bots][upload bots] from your local environment.
...
To find these log files, visit your [user profile][user profile]. You'll see a table of your errors, click to download the log files for a game.

[autocompiler]: https://github.com/HaliteChallenge/Halite/blob/master/worker/compiler.py
[upload bots]: /learn-programming-competition/halite-cli-and-tools/upload-bots
[user profile]: /user/user?me