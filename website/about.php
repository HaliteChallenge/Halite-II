    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <p>Halite was conceived of and developed by <a href="https://github.com/Sydriax">Benjamin Spector</a>, who partnered with his high school class-mate <a href="https://github.com/truell20">Michael Truell</a> to develop the game. Ben largely wrote the game implementation and starter packages, while Michael was primarily responsible for the website and the competition backend infrastructure. After receiving positive feedback on the Halite, the pair continually revised the game, extended it into the cloud and developed additional execution, leaderboard, and web interface capabilities.</p>
