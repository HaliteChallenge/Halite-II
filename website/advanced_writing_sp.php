    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <h3>General Starter Package Design</h3>
                ...
                <h2>Networking with the Environment</h2>
                ...
                Every bot is expected to respond with a string representing their name (newline-terminated) within fifteen seconds.</p>

                <h3>Turn Format</h3>

                <p>Every bot is sent the the present game map (newline-terminated).<br>Every bot is expected to respond with a set of moves (newline-terminated) within one second.</p>
                ...
                The above repeats until the <code>COUNTER</code> total is equal to the area of the map. It fills in the map from row 1 to row <code>HEIGHT</code> and within a row from column 1 to column <code>WIDTH</code>. Please be aware that the top row is the first row, as Halite uses screen-type coordinates.</p>
...
[0][1][2]</code></pre>
                ...
                <h3>Submitting Your New Starter Package</h3>
