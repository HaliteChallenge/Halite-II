$(function() {
    var table = {
        ...
        getTableWithSubmissions: function(startingRank, submissions) {
            var $table = $("<table class='table well well-sm' id='leaderTable'></table>");
            $table.append($("<thead><tr><th>#</th><th>Username</th><th>Language</th><th>Entries</th><th>Games</th><th>Score</th></tr></thead>"));
            ...
            console.log($table);
			var $tableWrapper = $("<div class='col-md-6'></div>"); 
