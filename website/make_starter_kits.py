...
INCLUDED_EXTENSIONS = [".py", ".java", ".cpp", ".hpp", ".cs", ".csproj", ".scala", ".js", ".sh", ".bat", ".toml", ".rs",".go",".txt",".rb", ".kt", ".clj"]
...
"ML-StarterBot-Python":"1.0", "Rust" : "0.9.0-beta", "Scala" : "0.9.0-beta", "Go" : "0.9.0-beta", "Ruby" : "0.9.0-beta" , "Kotlin" : "0.9.0-beta", "Clojure" : "0.9.0-beta" }
