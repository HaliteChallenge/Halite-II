...
INCLUDED_EXTENSIONS = [".py", ".java", ".cpp", ".hpp", ".cs", ".csproj", ".scala", ".js", ".sh", ".bat", ".toml", ".rs",".go",".txt" ]
...
versions =  {"Python3" : "1.0", "C++" : "0.9.0-beta", "Java" : "1.0", "CSharp" : "0.7.0-alpha" ,"JavaScript": "1.0",
