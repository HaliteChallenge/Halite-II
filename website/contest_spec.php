...
<body>
	<div class="container">
        ...
        <h3>Schedule</h3>
        <ul>
          <li>On Monday August 1th, participants who are not ranked higher than the "Basic Bot" user on the leaderboard will not be eligable for the playoffs. All participants who are ranked higher than the "Basic Bot" user on the leaderboard will be eligable for the playoffs</li>
