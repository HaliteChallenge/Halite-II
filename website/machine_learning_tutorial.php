        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <p>
                    ...
                    <p>
                        <a href="downloads/tutorials/Replays.zip">Here</a> is an archive of about 500 games that Matt's bot participates in. You can an archive of all of the games played on our servers with this command: <code>wget -e robots=off -r --no-parent http://192.241.158.114/</code>.
                    </p>

                    <p>
                        We want load and parse the replay files into lists of <code>GameMap</code> objects and moves, so that we can use the data contained in them. We can load in the data we need from an HLT file with this code:
